...
describe('add-integration mindsdb', () => {
  let tempDir: string
  ...
  async function fillBaseFields(
    ...
    await screen.next()
    expect(screen.getScreen()).toContain('Port: (47334)')
  ...
  it('creates mindsdb integration and stores password as env ref', async () => {
  ...
  it('creates mindsdb integration with SSH tunnel enabled', async () => {
