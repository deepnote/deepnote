...
describe('add-integration alloydb', () => {
  let tempDir: string
  ...
  it('creates alloydb integration and stores password as env ref', async () => {
  ...
  it('creates alloydb integration with SSH tunnel enabled', async () => {
