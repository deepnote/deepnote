import { EnvVarResolutionError } from '@deepnote/database-integrations'
import { afterEach, beforeEach, describe, expect, it } from 'vitest'
import { resolveEnvVarRefs } from './env-var-refs'
...
describe('resolveEnvVarRefs', () => {
  ...
  describe('complex structures', () => {
    ...
    it('throws error with path info for missing env vars in complex structure', () => {
      ...
      expect(() => resolveEnvVarRefs(config)).toThrow('Environment variable "MISSING_VAR" is not defined at "missing"')
    })
