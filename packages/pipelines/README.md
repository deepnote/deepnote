...
```bash
python3 packages/pipelines/python/deepnote_pipeline.py --plan pipeline.deepnote   # print the DAG
DEEPNOTE_TOKEN=… python3 packages/pipelines/python/deepnote_pipeline.py --run pipeline.deepnote
```
...
See [`examples/pipelines/scheduled`](../../examples/pipelines/scheduled) for
