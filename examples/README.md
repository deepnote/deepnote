...
To open a `.deepnote` project, use your favorite editor—[VS Code](https://code.visualstudio.com/), [Cursor](https://cursor.dev/), or [Windsurf](https://windsurf.com/)—or open it in [Deepnote Cloud](https://deepnote.com/).
