...
| Mac                            | Windows & Linux                               | Action                                                                                             |
| ------------------------------ | --------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| <Keyboard>⇧ + ↵</Keyboard>     | <Keyboard>shift + enter</Keyboard>            | <p>Run block and focus the next block</p><p>(creates a new cell if at the end of the notebook)</p> |
| <Keyboard>⌥ + ↵</Keyboard>     | <Keyboard>alt + enter</Keyboard>              | Run block and create a code block below                                                            |
| <Keyboard>⌘ + ↵</Keyboard>     | <Keyboard>ctrl + enter</Keyboard>             | Run block                                                                                          |
...
| <Keyboard>⌘ + ⇧ + M</Keyboard> | <Keyboard>ctrl + shift + M</Keyboard>         | Convert block to Markdown                                                                          |
...
| <Keyboard>⌘ + ⇧ + J</Keyboard> | <Keyboard>ctrl + shift + J</Keyboard>         | Add code block below                                                                               |
| <Keyboard>⌘ + ⇧ + K</Keyboard> | <Keyboard>ctrl + shift + K</Keyboard>         | Add code block above                                                                               |
| <Keyboard>⌘ + ⇧ + Y</Keyboard> | <Keyboard>ctrl + shift + Y</Keyboard>         | Convert block to code                                                                              |
