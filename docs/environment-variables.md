...
In this case, you can add an environment variable which will let you access the remote integration or third party service. For example, you can store the API key for an experiment tracking tool like [Weights & Biases](https://wandb.ai/) as an environment variable and read it from your notebook.
