...
- **Beam**: Use Beam to set up a hosted environment and deploy models directly from Deepnote. See [Beam's documentation](https://docs.beam.cloud/) for how to package models into endpoints.
